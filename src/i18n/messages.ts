export const en = {
  ...
  webglUnavailable: 'WebGL is unavailable. A textual summary is shown instead of the map.',
  play: 'Play',
  pause: 'Pause',
  restart: 'Restart',
  ...
  markerLabelHint: 'Show or hide each marker. Select a visible marker to show only its label.',
  derived: 'derived',
...
export const de: Record<MessageKey, string> = {
  ...
  webglUnavailable: 'WebGL ist nicht verfügbar. Statt der Karte wird eine Textzusammenfassung gezeigt.',
  play: 'Abspielen',
  pause: 'Pause',
  restart: 'Neustart',
  ...
  localTime: 'Ortszeit',
  utcTime: 'UTC',
  mapMarkers: 'Kartensteuerung',
  windArrows: 'Windpfeile',
  ...
  markerLabelHint: 'Jeden Marker ein- oder ausblenden. Sichtbaren Marker auswählen, um nur dessen Beschriftung anzuzeigen.',
  derived: 'abgeleitet',
